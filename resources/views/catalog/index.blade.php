        ...
        <div class="card-body">
            ...
            <form method="get" action="{{ route('vehicles.index') }}" class="row g-3 align-items-end">
                ...
                <div class="col-sm-6 col-md-3">
                    ...
                    <input name="brand" class="form-control form-control-lg" value="{{ request('brand') }}"
                        placeholder="EcoMove, VoltMoto">
                </div>
                <div class="col-6 col-md-2">
                    <label class="form-label">Precio min</label>
                    <input type="number" step="0.01" name="min_price" class="form-control form-control-lg"
                        value="{{ request('min_price') }}">
                </div>
                <div class="col-6 col-md-2">
                    <label class="form-label">Precio máx</label>
                    <input type="number" step="0.01" name="max_price" class="form-control form-control-lg"
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card glass h-100">
                    ...
                    <img class="vehicle-img"
                        src="https://source.unsplash.com/random/600x338/?{{ urlencode($tags) }}&sig={{ md5($seed) }}"
